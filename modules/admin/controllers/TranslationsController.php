...
use app\models\search\TranslationsSearch;
...
class TranslationsController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Translations",
                    'content' => '<span class="text-success">Create Translations success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Translations model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Translations model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
